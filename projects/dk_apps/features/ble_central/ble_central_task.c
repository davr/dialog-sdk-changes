...
static void handle_evt_gap_connected(ble_evt_gap_connected_t *evt)
{
        ...
        OS_TASK_NOTIFY(ble_central_task_handle, DISCOVER_NOTIF, OS_NOTIFY_SET_BITS);
}
...
static void handle_evt_gap_disconnected(ble_evt_gap_disconnected_t *evt)
{
        ...
        OS_TASK_NOTIFY(ble_central_task_handle, RECONNECT_NOTIF, OS_NOTIFY_SET_BITS);
}
...
OS_TASK_FUNCTION(ble_central_task, params)
{
        int8_t wdog_id;
