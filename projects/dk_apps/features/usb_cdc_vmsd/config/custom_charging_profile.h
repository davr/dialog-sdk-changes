...
/*
 * Informs the host on the minimum required current for the device
 * in combined Charging and USB activity.
 * The USB standard restriction is 500mA.
 * This can be lowered down to the application's actual power needs.
 * See also sys_charger_conf.cc_level
 */
#define MIN_GUARANTEED_CURRENT_BUDGET_mA        (500)
...
static const sys_charger_configuration_t sys_charger_conf = {
        {
                ...
                .cc_level = HW_CHARGER_I_LEVEL_200,
