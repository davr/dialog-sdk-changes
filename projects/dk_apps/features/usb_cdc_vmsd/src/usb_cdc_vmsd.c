 ...
 **********************************************************************
 */
static OS_TASK usb_cdc_rx_task_handle;
static OS_TASK usb_cdc_tx_task_handle;
static OS_EVENT wait_for_rx_task_to_finish;
...
__RETAINED static OS_TASK usb_init_task_handle;
/*********************************************************************
 *       For VMSD
 **********************************************************************
 */
...
static const USB_DEVICE_INFO _DeviceInfo = {
        ...
        "DA1470x CDC/VirtualMSD device",          // ProductName
...
static OS_TASK_FUNCTION(usb_vmsd_task, params)
{
...
uint32_t USB_VMSD_FS_BootSector_VolID_Config(void)
{
        ...
        if ((size == SIZE_OF_TRIM_VALUES) && (variant != NULL)) {
                return *variant;
        }
 ...
 *
 *********************************************************************/
static OS_TASK_FUNCTION(usb_init_task, params)
{
        OS_BASE_TYPE status;
