...
#if (__RAM9_SIZE_FOR_MAIN_PROC > 0)
        .ram9_area_for_m33 (NOLOAD) :
                __AT__ (__etext + RETENTION_TEXT_SIZE + RETENTION_RAM_INIT_SIZE + NON_RETENTION_RAM_INIT_SIZE)
        {
...
#if (__RAM10_SIZE_FOR_MAIN_PROC > 0)
        .ram10_area_for_m33 (NOLOAD) :
                __AT__ (__etext + RETENTION_TEXT_SIZE + RETENTION_RAM_INIT_SIZE + NON_RETENTION_RAM_INIT_SIZE + RAM9_DATA_FOR_M33_SIZE)
        {
