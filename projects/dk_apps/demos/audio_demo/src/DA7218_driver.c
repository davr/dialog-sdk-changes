...
#if SR1_48_SR2_32
# if BIT_DEPTH_16
#define _AUDIO_CODE_CONF        (DAI_16BIT_48KHz)
# elif BIT_DEPTH_32
#define _AUDIO_CODE_CONF        (DAI_32BIT_48KHz)
# endif
#elif SR1_16_SR2_8
# if BIT_DEPTH_16
#define _AUDIO_CODE_CONF                (DAI_16BIT_16KHz)
# elif BIT_DEPTH_32
#define _AUDIO_CODE_CONF        (DAI_32BIT_16KHz)
#define _AUDIO_CODE_CONF        (DAI_32BIT_16KHz)
# endif
#endif
...
#elif (_AUDIO_CODE_CONF == DAI_32BIT_16KHz)
#define SR_REG_VALUE            (0x55)    //16kHz sample rate for ADC and DAC
#define DAI_CTRL_REG_VALUE      (0xAC)     //DAI Enabled, DAI Channel 1L and 1R enabled, 16bit, I2S
...
static const TRegisterTable _ktCodecInit[] = {
        ...
        {PLL_FRAC_TOP_REG_adr,          0x93 }, // PLL FRAC_TOP=0x93
        {PLL_FRAC_BOT_REG_adr,          0x74 }, // PLL FRAC_BOT=0x74
        {PLL_INTEGER_REG_adr,           0x18 }, // PLL INTEGER=0x18  - PLL Set-up for 32MHz MCLK
        //STEP12= PLL ENABLE
        //-->write_reg(0x91, 0x43);
...
static void CmdInitI2c(void)
{
        ...
        hw_gpio_set_pin_function(I2C_SCL_PAD, HW_GPIO_MODE_INPUT, HW_GPIO_FUNC_I2C_SCL);
        hw_gpio_set_pin_function(I2C_SDA_PAD, HW_GPIO_MODE_INPUT, HW_GPIO_FUNC_I2C_SDA);
        hw_gpio_configure_pin_power(I2C_SCL_PAD, _GPIO_LVL);
        hw_gpio_configure_pin_power(I2C_SDA_PAD, _GPIO_LVL);
