...
static void wkup_gpio_p0_interrupt_cb()
{
        ...
        if (hw_wkup_get_gpio_status(SER1_CTS_PORT) & (1 << SER1_CTS_PIN)) {
                ...
                hw_wkup_clear_gpio_status(HW_GPIO_PORT_0, (1 << SER1_CTS_PIN));
        }
}
...
static void init_wakeup(void)
{
        ...
        hw_wkup_set_trigger(CFG_TRIGGER_PERFORM_NOTIF_ACTION_GPIO_PORT,
                                CFG_TRIGGER_PERFORM_NOTIF_ACTION_GPIO_PIN, HW_WKUP_TRIG_LEVEL_LO_DEB);
